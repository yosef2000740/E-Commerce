...
function shopList(idSection){
    let listProShop = document.getElementById(idSection).innerHTML="";
    let i=0;
    let product;
   ...
   <div  class="pro-container">
     <div class="pro">
       ...
       `;
        listProShop =document.getElementById(idSection).innerHTML+=contentFeature;
        i++;
    }
}
shopList("productShop");